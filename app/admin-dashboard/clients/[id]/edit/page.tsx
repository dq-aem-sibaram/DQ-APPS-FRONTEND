// app/admin-dashboard/clients/[id]/edit/page.tsx (edit client with backend)
'use client';
...
import { ClientModel, ClientDTO } from '@/lib/api/types';
import ProtectedRoute from '@/components/ProtectedRoute';

const EditClientPage = () => {
  const [formData, setFormData] = useState<ClientModel>({} as ClientModel);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push('/admin-dashboard/clients/list'); // Redirect to list after success
      }, 1500);
    } catch (err: any) {
